        ...
        <section aria-label="Technology skills and expertise" className="grid gap-5 md:grid-cols-2">
          {techStack.map((tech, index) => (
            ...
            >
              ...
              <div className="absolute -inset-0.5 rounded-xl bg-gradient-to-r from-blue-500/0 via-blue-500/20 to-blue-500/0 opacity-0 blur-lg transition-opacity duration-500 group-hover:opacity-100 dark:via-blue-500/30"></div>
                ...
                <div className="relative space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="relative">
                      <div className={`absolute inset-0 rounded-lg bg-gradient-to-br ${tech.color} opacity-20 blur-sm transition-all duration-500 group-hover:opacity-30 group-hover:blur-md`}></div>
                      <div className={`relative flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br ${tech.color} shadow-md transition-all duration-500 group-hover:scale-110 group-hover:shadow-lg`}>
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    <div className={`h-1 w-1 rounded-full bg-gradient-to-r ${tech.color} opacity-0 transition-opacity duration-500 group-hover:opacity-100`}></div>
                    <div className={`h-0.5 w-0 rounded-full bg-gradient-to-r ${tech.color} transition-all duration-700 group-hover:w-full`}></div>
                  </div>
                </div>
              </div>
            </div>
