...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-linear-to-br from-slate-50 via-blue-50 to-slate-100 dark:from-slate-950 dark:via-slate-950 dark:to-slate-950">
      ...
      {/* Scroll Indicator */}
      <div className="absolute bottom-4 left-1/2 z-10 -translate-x-1/2 animate-bounce sm:bottom-8">
      ...
      <div className="relative mx-auto grid min-h-screen max-w-7xl items-center gap-8 px-4 py-24 sm:gap-12 sm:px-6 sm:py-20 lg:grid-cols-2 lg:gap-20">
        {/* Left Content */}
        <div className="space-y-8">
          ...
          <div className="animate-fade-in animation-delay-200">
            <h1 className="text-3xl font-bold leading-[1.2] tracking-tight text-slate-900 dark:text-white sm:text-4xl md:text-5xl lg:text-6xl">
              I build{' '}
          ...
          {/* CTA Buttons */}
          <div className="animate-fade-in animation-delay-600 flex flex-col items-stretch gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
            <button
              onClick={() => scrollToSection('contact')}
              className="group flex items-center justify-center gap-2 rounded-full bg-blue-500 px-6 py-3 text-sm font-semibold text-white transition-all hover:bg-blue-600 hover:shadow-lg hover:shadow-blue-500/30 sm:px-8 sm:py-4 sm:text-base dark:bg-teal-500 dark:text-slate-950 dark:hover:bg-teal-400 dark:hover:shadow-teal-500/30"
            >
              Let&apos;s Talk
            ...
            <a
              href="/Colina-CV.pdf"
              download
              className="flex items-center justify-center gap-2 rounded-full border border-slate-300 bg-slate-50 px-6 py-3 text-sm font-semibold text-slate-900 transition-all hover:border-blue-500 hover:bg-slate-100 sm:px-8 sm:py-4 sm:text-base dark:border-slate-700 dark:bg-transparent dark:text-white dark:hover:border-teal-500 dark:hover:bg-slate-900"
            >
              <Download size={18} />
              Download CV
            </a>
        ...
        <div className="animate-fade-in animation-delay-400 relative flex items-center justify-center lg:justify-end">
          <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-none">
            ...
            <div className="group relative overflow-hidden rounded-3xl border border-blue-200/30 bg-linear-to-br from-white/80 via-blue-50/20 to-slate-50/50 p-2 shadow-2xl shadow-blue-500/5 backdrop-blur-sm transition-all duration-500 hover:border-blue-300/50 hover:shadow-3xl hover:shadow-blue-500/10 dark:border-teal-500/20 dark:from-slate-900/50 dark:via-slate-900/30 dark:to-slate-800/40 dark:shadow-teal-500/10 dark:hover:border-teal-500/40 dark:hover:shadow-teal-500/20">
              ...
              <div className="relative aspect-[3/4] w-full overflow-hidden rounded-2xl ring-1 ring-blue-100/50 shadow-lg transition-all duration-500 sm:h-auto lg:h-125 lg:w-95 group-hover:ring-blue-200/80 dark:ring-teal-500/10 dark:group-hover:ring-teal-500/30">
                <img
            ...
            {/* Available Badge */}
            <div className="absolute -bottom-4 right-0 z-10 flex items-center gap-2 rounded-xl border border-blue-200/60 bg-white/95 px-4 py-2 shadow-xl shadow-blue-500/10 backdrop-blur-md transition-all duration-300 hover:scale-105 hover:border-blue-300/80 hover:shadow-2xl hover:shadow-blue-500/20 sm:-bottom-6 sm:gap-3 sm:rounded-2xl sm:px-6 sm:py-3 dark:border-teal-500/30 dark:bg-slate-900/95 dark:shadow-teal-500/10 dark:hover:border-teal-500/50 dark:hover:shadow-teal-500/20">
              ...
              <p className="text-xs font-semibold text-slate-900 sm:text-sm dark:text-slate-100">Available for work</p>
            </div>
          </div>
        </div>
      </div>
